...
- **Fix**: Restored split Build/Release workflow strategy (originally v1.1.38) to resolve race conditions that caused releases to stick in "Draft" state and artifacts to be missing (404 errors).
